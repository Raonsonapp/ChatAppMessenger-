...
android {
    ...
    compileOptions {
        ...
        // flutter_local_notifications ба desugaring ниёз дорад.
    ...
    buildTypes {
        release {
            // Имзо бо калиди воқеии release (android/key.properties), агар мавҷуд бошад;
            // акс ҳолат бозгашт ба калиди debug, то `flutter run --release` кор кунад.
