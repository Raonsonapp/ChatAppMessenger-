...
/// Феҳристи ҷустуҷӯи корбарони воқеан бақайдгирифташуда (бо рақами телефон
/// ё ном). Пахши натиҷа сӯҳбати воқеиро мекушояд/эҷод мекунад.
...
class _NewChatSheetState extends State<NewChatSheet> {
  ...
  Future<void> _search(String query) async {
    ...
    // САБТ: ҷустуҷӯи воқеӣ дар байни корбарони бақайдгирифташудаи Firestore
  ...
  Future<void> _openChatWith(String otherUid, String otherName) async {
    ...
    // САБТ: эҷод/навсозии ҳуҷҷати сӯҳбат дар Cloud Firestore
      ...
      child: GlassContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Бо рақами телефон ё ном ҷустуҷӯ кунед',
