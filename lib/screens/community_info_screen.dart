          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(tr('k054'), style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.w600)),
                onTap: () {
                  Navigator.pop(context);
                  _removeMember(uid);
                },
        ...
        child: SafeArea(
          child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              final name = (data['name'] ?? tr('k004')) as String;
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        if (description.isNotEmpty) ...[
                          ...
                          Center(
                            child: Text(description, textAlign: TextAlign.center, style: TextStyle(color: AppColors.textSecondary, fontSize: 12.5)),
                          ),
                        ],
                        Center(
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton.icon(
                            ...
                            label: Text(tr('k058'), style: TextStyle(color: Colors.redAccent)),
