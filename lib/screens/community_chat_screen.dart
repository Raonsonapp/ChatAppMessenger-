...
class _CommunityChatScreenState extends State<CommunityChatScreen> {
  ...
  Future<void> _sendPoll() async {
    ...
    await _touchCommunity(draft.question, type: 'poll');
    _scrollToBottom();
  }
  ...
  String get _storageFolder => 'communities/${widget.communityId}';
  ...
  /// Интихоби паём: зер кардан онро илова ё бармедорад.
  ...
  /// Сарлавҳаи ҳолати интихоб — ба ҷои номи гурӯҳ.
    ...
    return Scaffold(
      ...
      body: NeonBackdrop(
        child: SafeArea(
          child: Column(
            children: [
              if (_selected.isNotEmpty) _buildSelectionHeader(currentUid) else _buildHeader(),
